...
export class ConfigGenerator {
  ...
  private groupItemsBy(rules: Rule[], rulesGrouping: RulesGrouping): Set<string> {
  ...
  public async generateRules(folderPath: string): Promise<void> {
    ...
    return writeFile(path.resolve(folderPath, `configs-by-${this.rulesGrouping}.ts`), output);
  }
}
