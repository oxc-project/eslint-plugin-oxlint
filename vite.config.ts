...
delete uniCornRecommended['unicorn/consistent-arrow-return-style'];
delete uniCornRecommended['unicorn/iteration-fallback-style'];
delete uniCornRecommended['unicorn/no-async-iterator-callback'];
delete uniCornRecommended['unicorn/no-barrel-files'];
delete uniCornRecommended['unicorn/no-deprecated-css-features'];
delete uniCornRecommended['unicorn/no-duplicate-css-selectors'];
delete uniCornRecommended['unicorn/no-duplicate-font-family-names'];
delete uniCornRecommended['unicorn/no-invalid-media-features'];
delete uniCornRecommended['unicorn/no-nesting-with-mixed-specificity'];
delete uniCornRecommended['unicorn/no-redundant-nested-style-rules'];
delete uniCornRecommended['unicorn/no-unknown-css-annotations'];
delete uniCornRecommended['unicorn/no-unknown-pseudo-selectors'];
delete uniCornRecommended['unicorn/no-unsafe-sqlite-interpolation'];
delete uniCornRecommended['unicorn/no-unscoped-css-nesting-selector'];
delete uniCornRecommended['unicorn/no-unused-builtin-method-return'];
delete uniCornRecommended['unicorn/no-unused-iterator-helper'];
delete uniCornRecommended['unicorn/no-useless-set-construction'];
delete uniCornRecommended['unicorn/no-using-resource-escape'];
delete uniCornRecommended['unicorn/prefer-combined-guards'];
delete uniCornRecommended['unicorn/prefer-iterator-zip'];
delete uniCornRecommended['unicorn/prefer-json-import'];
delete uniCornRecommended['unicorn/prefer-media-feature-range-syntax'];
delete uniCornRecommended['unicorn/prefer-temporal-conversion'];
delete uniCornRecommended['unicorn/prefer-uint8array-hex'];
delete uniCornRecommended['unicorn/single-line-block-comment-style'];
